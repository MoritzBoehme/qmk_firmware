...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PROGRAMMING] = LAYOUT_ansi_61(
        ...
        TD(LSFT), _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,                   TG(FN1),
        _______,  _______, _______,                            _______,                             _______, _______, MO(FN1), MO(FN2)),
