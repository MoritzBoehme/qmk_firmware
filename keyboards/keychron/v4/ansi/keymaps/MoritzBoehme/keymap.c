...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PROGRAMMING] = LAYOUT_ansi_61(
        ...
        TD(SFT), _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,                   TG(FN1),
        _______, TD(GUI), _______,                            _______,                             _______, _______, MO(FN1), MO(FN2)),
