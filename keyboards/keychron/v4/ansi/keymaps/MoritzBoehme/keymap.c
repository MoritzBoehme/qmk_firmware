...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [NORMAL] = LAYOUT_ansi_61(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                              KC_RALT, KC_RCTL, MO(FN1), MO(FN2)),
    ...
    [PROGRAMMING] = LAYOUT_ansi_61(
        ...
        TD_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,                   TG(FN1),
        _______, TD_LGUI, _______,                            _______,                             _______, _______, MO(FN1), MO(FN2)),
